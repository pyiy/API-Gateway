  ...
  useEffect(() => {
    const loadSettings = async () => {
      try {
        ...
        console.log('[AI API Manager] Register captcha settings:', data)
        
        if (data.success) {
          const captchaEnabled = data.settings.enable_register_captcha === 'true' || data.settings.enable_register_captcha === '1'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">创建您的账户</CardDescription>
        </CardHeader>
